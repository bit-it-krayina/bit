...
$cfg['mysqlhost'] = 'mysql3.000webhost.com';	// Database host URL
$cfg['mysqlport'] = '3306';				// Database port, if non-default
$cfg['mysqluser'] = 'a2879829_free';			// Database user
$cfg['mysqlpassword'] = 'qwerty123';			// Database password
$cfg['mysqldb'] = 'a2879829_free';		// Database name
...
$cfg['mainurl'] = 'http://it-kr.net84.net';
$cfg['site_id'] = '04a87abfe3fdcf5e4aa9c97116e21ed7';
$cfg['secret_key'] = 'f13ec3c2938efad3c5dbdde429378eee';
...
$db_x				= 'flance_'; // Default: cot_, prefix for extra fields' table(s)
