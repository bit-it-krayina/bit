...
$L['install_body_message2'] = 'It is recommended to copy datas/config.php to datas/config.php and set CHMOD 666 on datas/config.php before running this script.';
...
$L['install_error_config'] = 'Could not create or edit config file. Please save config.php as config.php and set CHMOD 777 on it';
...
$L['install_update_config_error'] = 'Cannot update datas/config.php. Please set CHMOD 664 or 666 on it and try again. If it does not help, make sure that datas/config.php exists.';
