...
$L['install_body_message2'] = 'Рекомендуем создать в папке datas файл config.php, скопировать в него содержимое файла config.php и установить на него права CHMOD 666.';
...
$L['install_error_config'] = 'Не удаётся создать или отредактировать файл конфигурации. Скопируйте содержимое файла config.php в config.php. Установите на файл config.php права CHMOD 777.';
...
$L['install_update_config_error'] = 'Невозможно обновить datas/config.php. Пожалуйста, установите CHMOD 664 или 666 на этот файл и попробуйте снова. Если это не помогло, убедитесь, что файл datas/config.php существует.';
